...
- Cinco hojas `Image Aug 19, 2026, ...`: fuentes del paquete de frames.

Se conservan los nombres de origen para mantener trazabilidad con el procesador y sus manifiestos. No son necesariamente los archivos más adecuados para insertarlos directamente en una pantalla: para eso están los estáticos y frames preparados de `03-mascota/`.
